...
3. Clone [Retina Repository](https://github.com/microsoft/retina) or download [Prometheus Values File](https://github.com/microsoft/retina/blob/main/deploy/standard/prometheus/values.yaml).
...
1. Use port forwarding to access Prometheus UI:
