...
func CreateTestInfraAZ(subID, clusterName, location, kubeConfigFilePath string, createInfra bool) *types.Job {
...
func InstallAndTestRetinaBasicMetrics(kubeConfigFilePath, chartPath string, cloudProvider string, testPodNamespace string) *types.Job {
...
func UpgradeAndTestRetinaAdvancedMetrics(kubeConfigFilePath, chartPath, valuesFilePath string, cloudProvider string, testPodNamespace string) *types.Job {
