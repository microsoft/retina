...
struct packet
{
    ...
    bool is_reply;
    __u32 previously_observed_packets; // When sampling, the is the number of observed packets since the last report.
    __u32 previously_observed_bytes; // When sampling, the is the number of observed bytes since the last report.
