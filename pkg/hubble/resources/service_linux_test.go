...
func TestNewServiceReconciler(t *testing.T) {
	...
	assert.Equal(t, ServiceReconcilerName, reconciler.logger.Logger.Name())
}
...
func TestServiceReconciler_Reconcile_ServiceCreated(t *testing.T) {
	...
	assert.Equal(t, expectedKey, reconciler.ipToService["10.96.0.1"])
	assert.Equal(t, expectedKey, reconciler.ipToService["10.96.0.2"])
...
func TestServiceReconciler_Reconcile_ServiceUpdated(t *testing.T) {
	...
	reconciler.mu.Lock()
	reconciler.ipToService["10.96.0.1"] = oldKey
	reconciler.ipToService["10.96.0.2"] = oldKey
	...
	assert.Equal(t, expectedKey, reconciler.ipToService["10.96.0.3"])
	assert.Equal(t, expectedKey, reconciler.ipToService["10.96.0.4"])
	assert.Contains(t, reconciler.serviceToIPs, expectedKey)
...
func TestServiceReconciler_Reconcile_ServiceDeleted(t *testing.T) {
	...
	reconciler.mu.Lock()
	reconciler.ipToService["10.96.0.1"] = serviceKey
	reconciler.ipToService["10.96.0.2"] = serviceKey
...
func TestServiceReconciler_Decode_IPv6(t *testing.T) {
	...
	reconciler.mu.Lock()
	reconciler.ipToService["fd00::1"] = serviceKey
...
func TestServiceReconciler_updateServiceCache(t *testing.T) {
	...
	assert.Equal(t, expectedKey, reconciler.ipToService["192.168.1.1"])
	assert.Equal(t, expectedKey, reconciler.ipToService["192.168.1.2"])
	assert.Contains(t, reconciler.serviceToIPs, expectedKey)
...
func TestServiceReconciler_removeServiceFromCache(t *testing.T) {
	...
	reconciler.mu.Lock()
	reconciler.ipToService["172.16.1.1"] = serviceKey
	reconciler.ipToService["172.16.1.2"] = serviceKey
...
func TestServiceReconciler_addServiceIPMappings(t *testing.T) {
	...
	assert.Equal(t, expectedKey, reconciler.ipToService["10.0.0.1"])
	assert.Equal(t, expectedKey, reconciler.ipToService["10.0.0.2"])
