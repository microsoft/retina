...
func TestNewCiliumIdentityReconciler(t *testing.T) {
	...
	assert.Equal(t, fakeClient, reconcilerOut.CiliumIdentityReconciler.Client)
	assert.NotNil(t, reconcilerOut.CiliumIdentityReconciler.labelsByIdentityID)
	assert.NotNil(t, reconcilerOut.CiliumIdentityReconciler.logger)
	assert.Equal(t, CiliumIdentityReconcilerName, reconcilerOut.CiliumIdentityReconciler.logger.Logger.Name())
}
...
func TestCiliumIdentityReconciler_Reconcile_IdentityCreated(t *testing.T) {
	...
	result, err := reconciler.CiliumIdentityReconciler.Reconcile(ctx, req)
...
func TestCiliumIdentityReconciler_Reconcile_IdentityUpdated(t *testing.T) {
	...
	_, err := reconciler.CiliumIdentityReconciler.Reconcile(ctx, req)
	require.NoError(t, err)
...
func TestCiliumIdentityReconciler_Reconcile_IdentityNotFound(t *testing.T) {
	...
	reconciler.CiliumIdentityReconciler.labelsByIdentityID[expectedID] = []string{"k8s:app=test"}
...
func TestCiliumIdentityReconciler_GetLabelsFromSecurityIdentity(t *testing.T) {
	...
	reconciler.CiliumIdentityReconciler.labelsByIdentityID[expectedID] = expectedLabels
...
func TestCiliumIdentityReconciler_updateIdentityCache(t *testing.T) {
	...
	result, err := reconciler.CiliumIdentityReconciler.updateIdentityCache(identity)
...
func TestCiliumIdentityReconciler_removeIdentityFromCache(t *testing.T) {
	...
	reconciler.CiliumIdentityReconciler.removeIdentityFromCache(objectKey)
...
func TestCiliumIdentityReconciler_ConcurrentAccess(t *testing.T) {
	...
	go func() {
		reconciler.CiliumIdentityReconciler.labelsByIdentityID[identityID] = labels
		done <- true
	}()
