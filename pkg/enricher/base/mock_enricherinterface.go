...
//
//	mockgen -destination=mock_enricherinterface.go -copyright_file=../lib/ignore_headers.txt -package=base github.com/microsoft/retina/pkg/enricher/base EnricherInterface
//
