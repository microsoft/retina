...
require (
	...
	sigs.k8s.io/mcs-api/controllers v0.0.0-20250724073829-5b846203867b // indirect
...
tool (
	...
	// github.com/goreleaser/goreleaser  // Temporarily removed due to moby/moby client conflict
