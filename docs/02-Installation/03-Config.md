...
To customize metrics and other optionas, upgrade Retina defining the specific parameter and attribute as part of the `helm upgrade` command. 
...
* `enableConntrackMetrics`: Enable conntrack metrics for packets and bytes forwarded/received.
